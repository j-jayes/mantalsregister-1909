...
```{r}
filenames <- list.files("data", pattern = "df_1830.*", full.names = TRUE) %>% as_tibble() %>% 
...
df %>% write_excel_csv("data/export_for_anton_1830.csv")
```
...
```{r}
# df %>% write_rds(here("data", "df_1800_compiled.rds"), compress = "gz")
```
