...
tibble(
  ...
  logos = c("https://media-exp1.licdn.com/dms/image/C4E0BAQFnF6tzuFOj_g/company-logo_200_200/0/1646154438464?e=1676505600&v=beta&t=0f_MZo2gRhZPYjZFdIxKhlwWXY9POvxxsX8pEdW4rew",
...
```{r}
# get data for Anton 1855

# list_of_files <- list.files(path = here::here("data", "birth_year"), pattern = ".rds")
# 
# df_1855 <- list_of_files %>%
#     as_tibble() %>%
#     mutate(value = str_c("data/birth_year/", value)) %>%
#     pull(value) %>%
#     map_dfr(read_rds)
# 
# df_1855 %>% 
#   unnest(data) %>% 
#   write_excel_csv(here::here("data", "export", "mantalsregister_data_1855.csv"))
```

### 1855 data including birth year

The data from 1855 also has birth year included. I have scraped this in a separeate file and link it for download [here in excel format](data/export/mantalsregister_data_1855.xlsx).
...
df %>%
  ...
  scale_y_continuous(labels = scales::number_format(), limits = c(0, NA)) +
